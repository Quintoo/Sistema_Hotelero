...
<body>
  ...
  <!-- Page Header -->
  <header class="masthead" style="background-image: url('../img/semaforo.jpg')">
      ...
      <div class="row">
        <div class="col-lg-8 col-md-10 mx-auto">
          <div class="site-heading">
            <h1>ITT Inn</h1>
            <span class="subheading">Sistema Hotelero</span>
          </div>
        </div>
      </div>
    </div>
      ...
      <div class="col-lg-8 col-md-10 mx-auto">
        <div class="post-preview">
          <a href="reservacion.php">
            <h2 class="post-title">
              En este simulador  de un Sistema Hotelero.
            </h2>
            <h3 class="post-subtitle">
              Hacer Reservaciones, observar las habitacion disponibles en Tiempo Real y  observaras las Ventas del mes.<br>Empezar...
            </h3>
          </a>
        </div>
        <hr>
